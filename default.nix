...
, config ? {}
# allows to override dependencies of the hasktorch-tutorial project without modifications
, sourcesOverride ? {}
...
let
  ...
  haskellPackages = recRecurseIntoAttrs
    ...
    (selectProjectPackages hasktorchTutorialHaskellPackages);
